				...
				<form action="<?php echo PUERTO."://".HOST;?>/registroresp/" method="post" id="forma_2">
					...
					foreach ($data as $cuestionario){
						if($preg_ant != $cuestionario['id_pregunta']){
							...
							echo "<div class='contenedor_p_2'>";
							$preg_ant = $cuestionario['id_pregunta'];
						}
						?>
							<div class="row text-justify">
								<div class="col-md-9">
									<div class="opcion_div">
										<input type="hidden" name="array_opcion[]" value="<?php echo $cuestionario['id_opcion']; ?>">
								...
								<div class="col-md-3">
									...
									<div class="orden_div">
										<input autocomplete="off" id="<?php  echo $cuestionario['id_opcion'];?>" type="text" maxlength="1" class="form-control form-control-sm" name="array_orden[]">
										<div></div>
									</div><br>
								</div>
							</div>
